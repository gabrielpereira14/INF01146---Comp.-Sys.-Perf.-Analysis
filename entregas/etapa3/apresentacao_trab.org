...
#+RESULTS:
: /home/gabip/perf/entregas/etapa3/
: /home/gabip/perf/data

*** Jitter Plot Function

#+NAME: plot_jitter
#+BEGIN_SRC python :var user="gabriel" :var image_size='(7 3) :results file graphics  :session graphs :exports both
...
df_l = df[(df['ping_latency_ms'] >= lb) & (df['ping_latency_ms'] <= ub)]
...
*** Throughput Upload Plot Function

#+NAME: plot_throughput
#+BEGIN_SRC python :var user="gabriel" :var image_size='(9 3) :results file graphics :session graphs :exports both
...
[[file:/home/gabip/perf/gabriel/images/throughput_gabriel.png]]
